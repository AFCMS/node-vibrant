	...
	packages: [
		{
			name: "vibrant-color",
			entryPoints: [
				resolve(__dirname, "../packages/vibrant-color/src/index.ts"),
			],
			tsconfig: resolve(
				__dirname,
		...
		},
		{
			name: "vibrant-core",
			entryPoints: [
				resolve(__dirname, "../packages/vibrant-core/src/index.ts"),
			],
			tsconfig: resolve(
				__dirname,
				"../packages/vibrant-core/tsconfig.docs.json",
			),
		...
		},
		{
			name: "vibrant-image",
			entryPoints: [
				resolve(__dirname, "../packages/vibrant-image/src/index.ts"),
			],
			tsconfig: resolve(
				__dirname,
		...
		},
		{
			name: "vibrant-types",
			entryPoints: [
				resolve(__dirname, "../packages/vibrant-types/src/index.ts"),
			],
			tsconfig: resolve(
				__dirname,
